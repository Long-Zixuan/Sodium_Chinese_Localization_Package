...
public class LaunchWarn 
{
    ...
    private static final String FALLBACK_MESSAGE = """
                    You have tried to launch Embeddium Chinese Localized Package (a Minecraft mod) directly, but it is not an executable program or mod installer. Instead, 
                    you must install Fabric Loader or Neoforge Loader for Minecraft, and then place this file in your mods directory.
                    
                    
                    看起来你试图执行Embeddium-汉化包模组，但是它并不是一个可执行程序或模组安装器。你需要安装Fabric加载器或者Neoforge加载器，然后将这个文件放到你的模组文件夹中。
                    ...
                    Il semble que vous essayiez d'exécuter un module de Embeddium, mais ce n'est pas un programme exécutable ou un installateur de module. Vous devez installer Fabric loader ou neoforge Loader, puis déposer ce fichier dans votre dossier modules.
    ...
    public static final String WINDOW_TITLE = "Embeddium-汉化包(ECLP)";
    ...
    {//使用String Buffer性能更好（虽然也不差这点性能）
        ...
        tmpRichMsg.append("<html>")
            ...
            .append("You have tried to launch Embeddium Chinese Localized Package (a Minecraft mod) directly, but it is not an executable program or mod installer. Instead, ")
            ...
            .append("<p style='width: 600px; padding: 0 0 8px 0;'>")
            .append("<br>看起来你试图执行Embeddium-汉化包模组，但是它并不是一个可执行程序或模组安装器。你需要安装Fabric加载器或者Neoforge加载器，然后将这个文件放到你的模组文件夹中。")
            .append("</p>")
            .append("<p style='width: 600px; padding: 0 0 8px 0;'>")
            ...
            .append("</p>")
            .append("<p style='width: 600px; padding: 0 0 8px 0;'>")
            .append("<br>Il semble que vous essayiez d'exécuter un module de Embeddium, mais ce n'est pas un programme exécutable ou un installateur de module. Vous devez installer Fabric loader ou neoforge Loader, puis déposer ce fichier dans votre dossier modules.")
            .append("</p>")
            .append("<p style='width: 600px; padding: 0 0 8px 0;'>")
