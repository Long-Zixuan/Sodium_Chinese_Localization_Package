...
public class SclpMixinPlugin implements IMixinConfigPlugin 
{
    ...
    {
        if(mixinClassName.equals("me.loongly.mods.sclp.mixin.reeses_sodium_options.MixinOptionPageScrollFrame")) 
        {
        ...
        if(mixinClassName.equals("me.loongly.mods.sclp.mixin.reeses_sodium_options.MixinSodiumVideoOptionsScreen")) {
            Optional<ModContainer> rsoOptionalModContainer = FabricLoader.getInstance().getModContainer("reeses-sodium-options");
        ...
        if(mixinClassName.equals("me.loongly.mods.sclp.mixin.reeses_sodium_options.MixinSodiumVideoOptionsScreenNew")) 
        {
            Optional<ModContainer> rsoOptionalModContainer = FabricLoader.getInstance().getModContainer("reeses-sodium-options");
        ...
        if(mixinClassName.equals("me.loongly.mods.sclp.mixin.reeses_sodium_options.OptionPageFrameMixin")) 
        {
            Optional<ModContainer> rsoOptionalModContainer = FabricLoader.getInstance().getModContainer("reeses-sodium-options");
