        ...
        if(mixinClassName.equals("me.loongly.mods.sclp.mixin.reeses_sodium_options.MixinSodiumVideoOptionsScreen")) 
        {
            ...
            if(rsoOptionalModContainer.isPresent()) 
            {
                ...
                try 
                {
                    ...
                    {
                        SCLPClientMod.LOGGER.warn("[SCLP] Reese's Sodium Options >= 1.4.2 detected. Mixin 'me.loongly.mods.sclp.mixin.reeses_sodium_options.MixinSodiumVideoOptionsScreen' will not be enabled");
                        return false;
                    }
                    else 
                        {
