package me.loongly.sclp.common.language;
...
public class LangFile 
{
        ...
        (
            ()->
            {
                ...
                if(langStr != null)
                {
                    ...
                    if(tmp == null)
                    {
                        SCLPClientMod.LOGGER.error("[SCLP]{} format error.", langUrl);
                    }
                    else
                    {
    ...
    {
        String url = "https://gitee.com/zixuan_long/Json/raw/master/sclp/1.21/lang/%s.json";
